...
export class TransportService {
  ...
  updateTransportZone(id, academicYear) {
    return this.http.put(AppSettings.API_ENDPOINT + 'Schools/' + id + '/updateZoneAcademicYear', academicYear, AppSettings.requestOptions()).map((response: Response) => response.json());
  }
